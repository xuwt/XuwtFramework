 ...
 * <dt>Queuing</dt>
 *
 * <dd>Any {@link LinkedBlockingQueue} may be used to transfer and hold
 ...
 * <ol>
 *
 * <li> In the default {@link com.xuwt.framework.cache.image.ThreadPoolExecutor.AbortPolicy}, the
 * handler throws a runtime {@link java.util.concurrent.RejectedExecutionException} upon
 * rejection. </li>
 *
 * <li> In {@link com.xuwt.framework.cache.image.ThreadPoolExecutor.CallerRunsPolicy}, the thread
 * that invokes {@code execute} itself runs the task. This provides a
 * simple feedback control mechanism that will slow down the rate that
 * new tasks are submitted. </li>
 *
 * <li> In {@link com.xuwt.framework.cache.image.ThreadPoolExecutor.DiscardPolicy}, a task that
 * cannot be executed is simply dropped.  </li>
 *
 * <li>In {@link com.xuwt.framework.cache.image.ThreadPoolExecutor.DiscardOldestPolicy}, if the
...
public class ThreadPoolExecutor {
	...
	public final static ThreadPoolExecutor get() {
        synchronized (mLock) {
            if (mInstance == null) {
                mInstance = new ThreadPoolExecutor(3, 5, 3, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>());
            }
            return mInstance;
        }
    }
    ...
    private List<Runnable> drainQueue() {
        LinkedBlockingQueue<Runnable> q = workQueue;
    ...
    public void execute(Runnable command) {
        ...
        if (isRunning(c) && workQueue.offer(command)) {
            ...
            if (! isRunning(recheck) && remove(command)) {
            	LogUtils.info(TAG, "the queue is full, removed");
     ...
     */
    public void purge() {
        final LinkedBlockingQueue<Runnable> q = workQueue;
        try {
    ...
    static class DefaultThreadFactory implements ThreadFactory {
        ...
        DefaultThreadFactory() {
            ...
            namePrefix = "ThreadPoolExecutor-thread-";
        }
