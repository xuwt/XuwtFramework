 ...
 * {@link ThreadPoolExecutor} and {@link java.util.concurrent.FutureTask}.</p>
 *
...
abstract class AsyncTask<Params, Progress, Result> {
    ...
    public static final ThreadPoolExecutor SERIAL_EXECUTOR = 
    		Executors.newFixedThreadPool(1, sThreadFactory);

    public static final ThreadPoolExecutor DUAL_THREAD_EXECUTOR =
    ...
    private static volatile ThreadPoolExecutor sDefaultExecutor = SERIAL_EXECUTOR;
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link com.xuwt.framework.cache.image.AsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
    ...
    /** @hide */
    public static void setDefaultExecutor(ThreadPoolExecutor exec) {
        sDefaultExecutor = exec;
    }
    
    public static void clearQuene() {
    	if(null != sPoolWorkQueue) {
     ...
     *         {@link com.xuwt.framework.cache.image.AsyncTask.Status#RUNNING} or {@link com.xuwt.framework.cache.image.AsyncTask.Status#FINISHED}.
     *
